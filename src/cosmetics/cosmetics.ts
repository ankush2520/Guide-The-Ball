...
export interface Cosmetic {
  ...
  kind: CosmeticKind;
  name: string;
  /** Coins in the shop, or null for chest-only. */
  price: number | null;
...
export const COSMETICS: readonly Cosmetic[] = [
  ...
  { id: 'ball-galaxy',  kind: 'ball', name: 'Galaxy',  price: null, colors: ['#f4e9ff', '#9b7bff', '#3b2a8a'] },
  ...
  { id: 'trail-rainbow', kind: 'trail', name: 'Rainbow', price: null, colors: ['rainbow'] },
  // ---- ramps ----
  ...
  { id: 'ramp-gold',    kind: 'ramp', name: 'Gold',    price: null, colors: ['#f0a80e'] },
];
